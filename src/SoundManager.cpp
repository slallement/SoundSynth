...
/** repeat the raw vector into the result (SAMPLES/size of raw) times
* note: it may clip if this is a non integer value */
std::vector<sf::Int16> SoundManager::repeat(const std::vector<sf::Int16> & raw, double freq) {
